    ...
    <div class="main-container d-flex">
        <div class="sidebar" id="side_nav">
            ...
            <ul class="list-unstyled px-2">
                <li class=""><a href="{{ route('company.form') }}" class="text-decoration-none px-3 py-2 d-block"><i
                            class="fa-solid fa-building"></i> Register Company</a></li>
                <li class=""><a href="{{ route('employe.register') }}" class="text-decoration-none px-3 py-2 d-block"><i
